                        ...
                        <form action="{{ route('dashboard.setting') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="company_fullname" name="fullname" value="{{ config('dashboard.company_fullname')}}">
                                </div>
                                <div class="form-group">
                                    <label for="company_name">Short Company Name</label>
                                    <input type="text" class="form-control" id="company_name" name="name" value="{{ config('dashboard.company_name')}}">
                                </div>
                                <div class="form-group">
                                    <label for="company_url">Company Url</label>
                                    <input type="text" class="form-control" id="company_url" name="url" value="{{ config('dashboard.company_url')}}">
                                </div>
                                <div class="form-group">
                                    <label for="company_email">Company Email</label>
                                    <input type="text" class="form-control" id="company_email" name=email" value="{{ config('dashboard.company_email')}}">
                                </div>
                                <div class="form-group">
                                    <label for="time_zone" >Time Zone</label>
                                    <input type="text" class="form-control" id="time_zone"  name="time_zone" value="{{ config('dashboard.time_zone')}}">
                                </div>
                                <div class="form-group">
                                    <label for="company_sologon" >Company Sologon</label>
                                    <input type="text" class="form-control" id="company_sologon" name="sologon" value="{{ config('dashboard.company_sologon')}}">
                                </div>
                            </div>
