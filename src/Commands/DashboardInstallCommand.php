...
class DashboardInstallCommand extends Command
{
    ...
    public function handle()
    {
            ...
            copyDirectory(__DIR__ . '/../Traits', app_path('Traits/'));

            (new Filesystem)->ensureDirectoryExists(app_path('Policies'));
            copyDirectory(__DIR__ . '/../Policies', app_path('Policies/'));

            (new Filesystem)->ensureDirectoryExists(base_path('database/seeders'));
            copyDirectory(__DIR__ . '/../../database/seeders', base_path('database/seeders/'));
