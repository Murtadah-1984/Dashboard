...
<script type="text/javascript">
     ...
     * --------------------------------------------
     */
    let roleSelector=makeSelector('#editRole_id','Select a Role','{{ route('roles.create') }}');
    let rolesSelector=makeSelector('#editRoles','Select Additional Roles','{{ route('roles.create') }}');
